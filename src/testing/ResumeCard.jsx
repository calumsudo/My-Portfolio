  ...
  return (
    <div>
        <Box sx={{backgroundColor: 'blue'}}>
            ...
            <h3>The Complete Web Development Bootcamp - Bogdan Stashchuk</h3>
            <p>
            ...
            <h3>Python for Data Science and Machine Learning BootCamp - Jose Portilla</h3>
            <p>
            ...
            <h3>iOS & Swift - The Complete iOS App Development Bootcamp - Dr.Angela Yu</h3>
            <p>
            ...
            <h3>Machine Learning, Data Science and Deep Learning with Python</h3>
            <p>
