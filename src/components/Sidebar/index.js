...
import { faHome, faUser, faEnvelope, faGrip, faScroll } from '@fortawesome/free-solid-svg-icons'
...
const Sidebar = () =>  {
    return(
        ...
        <ul>
            <li>
                <a target="_blank" rel='noreferrer' href="https://www.linkedin.com/in/calum-siemer-9bb31a167/">
                    <IconButton>
            ...
            <li>
                <a target="_blank" rel='noreferrer' href="https://github.com/calumsudo">
                    <IconButton>
